...
$showSidebarForm = (isset($showSidebarForm)) ? $showSidebarForm : false;
        ...
        <div id="record_form" class="container">
            ...
            <div class="page-content">
                <div class="layout-sidebarForm">
                    <?php 
                    if($showSidebarForm){
                        $this->render("parts" . DIRECTORY_SEPARATOR . "bi-less-sidebarForm");
                        };
                    ?>
                    
                    <div class="<?= ($showSidebarForm) ? 'main-with-sidebar' : '' ?>">
                    <?php if($showSidebarForm){ ?>
                        <a class="btn-xs btn-sidebar" role="button" title="Visualizza sidebar" data-toggle="collapse" href="#sidebarForm" aria-expanded="false" aria-controls="sidebarForm">
                            <span class="mdi mdi-backburger mdi-flip-h"></span>
                        </a>
                        <?php }; ?>
